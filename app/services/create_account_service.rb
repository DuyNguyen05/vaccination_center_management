class CreateAccountService
  ...
  def create_account(admin = nil)
    if @info_injection_book_id.present?
      ...
      Account.create! user_code: user_code, password: ENV.fetch("INIT_PASSWORD") {"12345678"},
      ...
      Admin.create! user_code: user_code, password: ENV.fetch("INIT_PASSWORD") {"12345678"},
        details_info_id: @details_info_id, role_id: Settings.active_record.account.role.admin
    else
